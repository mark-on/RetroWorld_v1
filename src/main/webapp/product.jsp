<%@ page import="java.util.Base64" %>
	...
	<script src="https://kit.fontawesome.com/7b1a8e0c2b.js" crossorigin="anonymous"></script>
			...
			<div id="image_p">
		  	...
		  	<div id="info_p">
		    	...
		    	<div class="quantity_container">
					...
					<input type="number" id="quantity" name="quantity" min="1" max="10" step="1" style="width: 20px;" value="1" required>
					<input type="hidden" id="productId" name="productId" value="<%= product.getId()%>">
				</div>
			   <button class="cta"  onclick="addToCart()" style="cursor:pointer" >
				    <span class="span"><img src="image/cart_2.png"></span>
				    <span class="second">
